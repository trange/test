				...
				<table>
					...
					<s:form action="UserContactAction">
						...
						<tr>
							...
							<td>
								<input type="text" name="userMellAdd" value=""/>
							</td>
						...
						<tr>
							...
							<td>
								<input type="text" name="userContact" value=""/>
							</td>
