...
<link rel="stylesheet" type="text/css"
	href="./css/productListDetail.css">
<title>商品詳細画面</title>
	...
	<div id="main">
		<div class="pageback">
			<a href='<s:url action="GoHomeAction"/>'>TOP</a> &nbsp;> <a
				href='<s:url action="ProductInfoAction"/>'>商品一覧</a> &nbsp;>&nbsp; <a>商品詳細</a>
		</div>
			...
			<s:else>
				...
				<div class="detail_box">
					<div class="product_name_kana">
						<s:property value="productInfoDTO.productNameKana" />
					</div>
					<div class="product_name">
						<s:property value="productInfoDTO.productName" />
					</div>
					<br>
					<div class="product_description">
						<s:property value="productInfoDTO.productDescription" />
					</div>
					<br>
					<div class="price">
						税込
						<fmt:formatNumber value="${productInfoDTO.price}" />
						円
					</div>
					<div class="release_company">
						発売会社:
						<s:property value="productInfoDTO.releaseCompany" />
					</div>
					<div class="release_date">
						発売年月日:
						<s:date name="productInfoDTO.releaseDate" format="yyyy年MM月dd日" />
					</div>
