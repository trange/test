					...
					<s:form action="CheckUserInfoAction" theme="simple"
						...
						<div class="member_form_text">
							<s:textfield type="text" name="familyName" value="%{familyName}"
								class="validate[required,custom[name],minSize[1],maxSize[16]]" />
						</div>
						...
						<div class="member_form_text">
							<s:textfield type="text" name="familyNameKana"
								...
								class="validate[required,custom[name2],minSize[1],maxSize[16]]" />
							<br>
						</div>
						...
						<div class="member_form_text">
							<s:textfield type="text" name="userId" value="%{userId}"
								class="validate[required,custom[login],minSize[1],maxSize[16]]" />
							<br>
						</div>
						...
						<div class="member_form_text">
							<s:password name="password" value="%{password}"
								class="validate[required,custom[password],minSize[1],maxSize[8]]" />
							<br>
						</div>
						...
						<div class="member_form_text">
							<s:textfield type="text" name="email" value="%{email}"
								class="validate[required,custom[email2],minSize[18],maxSize[32]]" />
							<br>
						</div>
